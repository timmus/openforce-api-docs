# Openforce OpenAPI Specification
[![Build Status](https://travis-ci.org/timmus/openforce-api-docs.svg?branch=master)](https://travis-ci.org/timmus/openforce-api-docs)
...
6. If you did everything correct, https://timmus.github.io/openforce-api-docs/ will lead to your new docs
...
- Documentation(ReDoc): https://timmus.github.io/openforce-api-docs/
- SwaggerUI: https://timmus.github.io/openforce-api-docs/swagger-ui/
- Look full spec:
    + JSON https://timmus.github.io/openforce-api-docs/swagger.json
    + YAML https://timmus.github.io/openforce-api-docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://timmus.github.io/openforce-api-docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://timmus.github.io/openforce-api-docs/ with url from the message: `Server started <url>`
