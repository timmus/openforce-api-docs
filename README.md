...
[![Build Status](https://travis-ci.org/oforce/openforce-api-docs.svg?branch=master)](https://travis-ci.org/oforce/openforce-api-docs)
...
6. If you did everything correct, https://oforce.github.io/openforce-api-docs/ will lead to your new docs
...
- Documentation(ReDoc): https://oforce.github.io/openforce-api-docs/
- SwaggerUI: https://oforce.github.io/openforce-api-docs/swagger-ui/
- Look full spec:
    + JSON https://oforce.github.io/openforce-api-docs/swagger.json
    + YAML https://oforce.github.io/openforce-api-docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://oforce.github.io/openforce-api-docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://oforce.github.io/openforce-api-docs/ with url from the message: `Server started <url>`
